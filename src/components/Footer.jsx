			...
			<div className="flex-center">
				<div className="footer_container">
					...
					<div className="footer_links">
						<div className="footer_wrapper flex-col-reverse-mobile">
						...
						<div className="footer_wrapper flex-col-mobile">
					...
					<div className="footer_pay">
						<div className="footer_pay-text">Gizlilik Politikası | Hizmet Sözleşmesi | KVKK Bildirimi</div>
					...
					<div className="footer_info">
						Kendinize/bir başkasına zarar vermeyi ya da intihar etmeyi düşünüyorsanız lütfen bu platformu
						kullanmayın.
					</div>
				</div>
			</div>
